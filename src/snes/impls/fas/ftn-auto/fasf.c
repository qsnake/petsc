...
extern "C" {
#endif
void PETSC_STDCALL  snesfascreatecoarsevec_(SNES snes,Vec *Xcoarse, int *__ierr ){
*__ierr = SNESFASCreateCoarseVec(
	(SNES)PetscToPointer((snes) ),Xcoarse);
}
void PETSC_STDCALL  snesfasrestrict_(SNES fine,Vec Xfine,Vec Xcoarse, int *__ierr ){
