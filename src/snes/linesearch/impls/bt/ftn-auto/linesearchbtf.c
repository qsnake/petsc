...
extern "C" {
#endif
void PETSC_STDCALL  sneslinesearchbtsetalpha_(SNESLineSearch linesearch,PetscReal *alpha, int *__ierr ){
*__ierr = SNESLineSearchBTSetAlpha(
	(SNESLineSearch)PetscToPointer((linesearch) ),*alpha);
}
void PETSC_STDCALL  sneslinesearchbtgetalpha_(SNESLineSearch linesearch,PetscReal *alpha, int *__ierr ){
